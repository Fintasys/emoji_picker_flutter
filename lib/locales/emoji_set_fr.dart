...
// ======================================================= Category.SMILEYS
  CategoryEmoji(Category.SMILEYS, [
    ...
    Emoji('🖐️', 'doigts | main | main levée doigts écartés | paume | stop ',
        hasSkinTone: true),
    Emoji(
        '✋', 'feuille | main | main levée | paume de la main | stop | tope là',
        hasSkinTone: true),
    Emoji('🖖', 'doigts | main | salut vulcain | Spock | Star Trek | vulcain',
        hasSkinTone: true),
    Emoji('👌',
    ...
    Emoji('🫰',
        ...
        hasSkinTone: true),
    Emoji('🤞', 'bonne chance | chance | croisés | doigts | main',
        hasSkinTone: true),
    Emoji('🤟',
    ...
    Emoji('👎',
        ...
        hasSkinTone: true),
    Emoji('✊', 'main | pierre | poing | poing levé | poing serré | solidarité',
        hasSkinTone: true),
    Emoji('👊',
        'absolument | battre | boum | correct | coup de poing | d’accord | main | mon pote | poing | poing de face | serrer',
        hasSkinTone: true),
    Emoji('🤛', 'fistbump | gauche | main | poing | poing à gauche',
        hasSkinTone: true),
    ...
    Emoji('🙌',
        ...
        hasSkinTone: true),
    Emoji('👐', 'main | mains écartées | mains ouvertes | ouvert',
        hasSkinTone: true),
    Emoji('🤲',
    ...
    Emoji('🦵',
        ...
        hasSkinTone: true),
    Emoji('🦶', 'cheville | coup de pied | pas lourd | pied',
        hasSkinTone: true),
    Emoji('👂', 'corps | écouter | entendre | oreille | ouïe | son',
        hasSkinTone: true),
    ...
    Emoji('👶', 'bébé | émoticône | enceinte | enfant | nouveau-né | petit',
        hasSkinTone: true),
    Emoji('🧒', 'enfant | genre neutre | jeune | non-genré', hasSkinTone: true),
    Emoji('👦', 'émoticône | enfant | garçon | jeune | personne',
        hasSkinTone: true),
    Emoji('👧',
    ...
    Emoji('👨', 'ami | garçon | homme | personne | petit ami | pote',
        hasSkinTone: true),
    Emoji('🧔', 'barbe | barbu | personne avec une barbe | personne barbue',
        hasSkinTone: true),
    Emoji('👱',
    ...
    Emoji('👨‍🦲',
        ...
        hasSkinTone: true),
    Emoji('👩', 'blonde | coupe de cheveux | femme | personne',
        hasSkinTone: true),
    Emoji('👱‍♀️',
    ...
    Emoji('👩‍🦲',
        ...
        hasSkinTone: true),
    Emoji('🧓', 'adulte | âgé | genre neutre | non-genré | personne âgée',
        hasSkinTone: true),
    Emoji('👴',
    ...
    Emoji('👩‍⚖️',
        ...
        hasSkinTone: true),
    Emoji('👨‍🌾', 'agriculteur | fermier | homme | jardinier | métier',
        hasSkinTone: true),
    Emoji('👩‍🌾', 'agricultrice | femme | fermière | jardinière | métier',
        hasSkinTone: true),
    ...
    Emoji('👩‍🎤',
        ...
        hasSkinTone: true),
    Emoji('👨‍🎨', 'artiste | homme | métier | palette | peintre',
        hasSkinTone: true),
    Emoji('👩‍🎨', 'artiste | femme | métier | palette | peintre',
        hasSkinTone: true),
    Emoji('👨‍✈️',
    ...
    Emoji('👨‍🚒',
        ...
        hasSkinTone: true),
    Emoji('👩‍🚒', 'camion de pompiers | casque | femme | métier | pompier',
        hasSkinTone: true),
    Emoji('👮‍♂️',
    ...
    Emoji('💃',
        ...
        hasSkinTone: true),
    Emoji('🕴️', 'affaires | costume | homme | homme d’affaires en lévitation ',
        hasSkinTone: true),
    Emoji(
      '👯‍♂️',
...
// ======================================================= Category.ACTIVITIES
  CategoryEmoji(Category.ACTIVITIES, [
    ...
    Emoji('🧗‍♀️',
        ...
        hasSkinTone: true),
    Emoji('🏇', 'cheval | course de chevaux | course hippique | jockey | sport',
        hasSkinTone: true),
    Emoji(
      '⛷️',
