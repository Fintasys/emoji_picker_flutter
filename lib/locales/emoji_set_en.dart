...
// ======================================================= Category.SMILEYS
  CategoryEmoji(Category.SMILEYS, [
    ...
    Emoji('🖐️', 'finger | fingers | hand | raised | splayed | stop ',
        hasSkinTone: true),
    ...
    Emoji('👈', 'backhand | finger | hand | index | left | point | pointing',
        hasSkinTone: true),
    Emoji('👉', 'backhand | finger | hand | index | point | pointing | right',
        hasSkinTone: true),
    Emoji('👆', 'backhand | finger | hand | index | point | pointing | up',
        hasSkinTone: true),
    Emoji('🖕', 'finger | hand | middle', hasSkinTone: true),
    Emoji('👇', 'backhand | down | finger | hand | index | point | pointing',
        hasSkinTone: true),
    Emoji('☝️', 'finger | hand | index | point | pointing | this | up ',
        hasSkinTone: true),
    Emoji('👍', '+1 | good | hand | like | thumb | up | yes',
        hasSkinTone: true),
    Emoji('👎',
        '-1 | bad | dislike | down | good | hand | no | nope | thumb | thumbs',
        hasSkinTone: true),
    Emoji('✊', 'clenched | fist | hand | punch | raised | solidarity',
        hasSkinTone: true),
    Emoji('👊',
    ...
    Emoji('🤲',
        ...
        hasSkinTone: true),
    Emoji('🤝', 'agreement | deal | hand | handshake | meeting | shake',
        hasSkinTone: true),
    Emoji('🙏',
        'appreciate | ask | beg | blessed | bow | cmon | five | folded | gesture | hand | high | please | pray | thanks | thx',
        hasSkinTone: true),
    Emoji('🫵', 'at | finger | hand | index | pointing | poke | viewer | you',
        hasSkinTone: true),
    ...
    Emoji(
        ...
        hasSkinTone: true),
    Emoji('👃', 'body | nose | noses | nosey | odor | smell | smells',
        hasSkinTone: true),
    Emoji(
      '🧠',
    ...
    Emoji('👶',
        ...
        hasSkinTone: true),
    Emoji('🧒', 'bright-eyed | child | grandchild | kid | young | younger',
        hasSkinTone: true),
    Emoji('👦',
    ...
    Emoji('👨‍🦰', 'adult | bro | man ginger | hair | red | redhead ',
        hasSkinTone: true),
    Emoji('👨‍🦱', 'adult | bro | man afro | curly | hair | ringlets ',
        hasSkinTone: true),
    Emoji('👨‍🦳', 'adult | bro | man gray | hair | old | white ',
        hasSkinTone: true),
    Emoji('👨‍🦲',
    ...
    Emoji(
        '👱‍♀️', 'blond | blond-haired | human | person female | sign | woman ',
        hasSkinTone: true),
    Emoji('👩‍🦰', 'adult | lady | woman ginger | hair | red | redhead ',
        hasSkinTone: true),
    Emoji('👩‍🦱', 'adult | lady | woman afro | curly | hair | ringlets ',
        hasSkinTone: true),
    Emoji('👩‍🦳', 'adult | lady | woman gray | hair | old | white ',
        hasSkinTone: true),
    Emoji('👩‍🦲',
        'adult | lady | woman bald | chemotherapy | hair | hairless | no | shaven ',
        hasSkinTone: true),
    Emoji('🧓', 'adult | elderly | grandparent | old | person | wise',
        hasSkinTone: true),
    Emoji('👴',
    ...
    Emoji('👨‍🏫', 'instructor | lecturer | man | professor | teacher',
        hasSkinTone: true),
    Emoji('👩‍🏫', 'instructor | lecturer | professor | teacher | woman',
        hasSkinTone: true),
    Emoji('👨‍⚖️',
    ...
    Emoji('👨‍🔧', 'electrician | man | mechanic | plumber | tradesperson',
        hasSkinTone: true),
    Emoji('👩‍🔧', 'electrician | mechanic | plumber | tradesperson | woman',
        hasSkinTone: true),
    Emoji('👨‍🏭', 'assembly | factory | industrial | man | worker',
        hasSkinTone: true),
    Emoji('👩‍🏭', 'assembly | factory | industrial | woman | worker',
        hasSkinTone: true),
    Emoji('👨‍💼',
    ...
    Emoji('👮‍♀️',
        ...
        hasSkinTone: true),
    Emoji('🕵️‍♂️', 'detective | sleuth | spy male | man | sign ',
        hasSkinTone: true),
    Emoji('🕵️‍♀️', 'detective | sleuth | spy female | sign | woman ',
        hasSkinTone: true),
    Emoji('💂‍♂️',
    ...
    Emoji('👸',
        ...
        hasSkinTone: true),
    Emoji('👳‍♂️', 'person | turban | wearing male | man | sign ',
        hasSkinTone: true),
    Emoji('👳‍♀️', 'person | turban | wearing female | sign | woman ',
        hasSkinTone: true),
    Emoji('👲',
    ...
    Emoji('🤶',
        ...
        hasSkinTone: true),
    Emoji('🦸‍♂️', 'good | hero | superhero | superpower male | man | sign ',
        hasSkinTone: true),
    Emoji(
        '🦸‍♀️', 'good | hero | superhero | superpower female | sign | woman ',
        hasSkinTone: true),
    Emoji('🦹‍♂️',
