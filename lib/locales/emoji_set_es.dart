...
// ======================================================= Category.SMILEYS
  CategoryEmoji(Category.SMILEYS, [
    ...
    Emoji(
      '🤔',
      'cara | cara pensativa | duda | pensando',
    ),
    Emoji(
      '🤐',
    ...
    Emoji(
      '🤥',
      'cara | cara de mentiroso | mentiroso | nariz | pinocho',
    ),
    Emoji(
      '😌',
    ...
    Emoji(
      '😷',
      'cara | cara con mascarilla médica | enfermo | malo | máscara',
    ),
    Emoji(
      '🤒',
    ...
    Emoji(
      '🤧',
      'cara | cara estornudando | estornudar | estornudo | pañuelo',
    ),
    Emoji(
      '🥵',
    ...
    Emoji(
      '😎',
      'cara | cara sonriendo con gafas de sol | gafas | guay | sol',
    ),
    Emoji(
      '🤓',
    ...
    Emoji(
      '😰',
      'ansiedad | cara | cara con ansiedad y sudor | frío | sudor',
    ),
    Emoji(
      '😥',
    ...
    Emoji(
      '😭',
      'cara | cara llorando fuerte | lágrima | llorar | triste',
    ),
    Emoji(
      '😱',
    ...
    Emoji(
      '😡',
      'cabreo | cara | cara cabreada | enfadado | furia',
    ),
    Emoji(
      '😠',
    ...
    Emoji(
      '👹',
      'cara | cuento | cuernos | demonio japonés oni | sonrisa',
    ),
    Emoji(
      '👺',
    ...
    Emoji(
      '👻',
      'cara | criatura | cuento | fantasma | monstruo',
    ),
    Emoji(
      '👽',
      'alien | alienígena | cara | criatura | extraterrestre | ovni',
    ),
    Emoji(
      '👾',
    ...
    Emoji(
      '😹',
      'cara | gato | gato llorando de risa | lágrima | risa',
    ),
    Emoji(
      '😻',
    ...
    Emoji(
      '😼',
      'cara | gato | gato haciendo una mueca | irónico | sonrisa',
    ),
    Emoji(
      '😽',
      'beso | cara | cariñoso | gato | gato besando',
    ),
    Emoji(
      '🙀',
    ...
    Emoji(
      '😿',
      'cara | gato | gato llorando | lágrima | pena | triste',
    ),
    Emoji(
      '😾',
      'cara | enfadado | gato',
    ...
    Emoji('👋', 'agitar | mano | mano saludando | saludar | saludo',
        hasSkinTone: true),
    Emoji('🤚', 'dorso | dorso de la mano | levantado | mano',
        hasSkinTone: true),
    ...
    Emoji('👌', 'aprobación | mano | ok | señal de aprobación con la mano',
        hasSkinTone: true),
    Emoji('🤌',
        'dedos | dedos juntos apuntando hacia arriba | gesto | italia | italiano | mano | sarcasmo',
        hasSkinTone: true),
    Emoji('🤏', 'mano pellizcando | pellizco | poco | poquito',
        hasSkinTone: true),
    Emoji('🫳',
    ...
    Emoji('🫰',
        ...
        hasSkinTone: true),
    Emoji('🤞', 'cruzar | dedos | dedos cruzados | mano | suerte',
        hasSkinTone: true),
    ...
    Emoji('👆',
        ...
        hasSkinTone: true),
    Emoji('🖕', 'corazón | dedo | dedo corazón hacia arriba | mano | peineta',
        hasSkinTone: true),
    Emoji('👇',
        'abajo | apuntar | dedo | dorso de mano con índice hacia abajo | mano',
        hasSkinTone: true),
    Emoji('☝️', 'apuntar | arriba | dedo | dedo índice hacia arriba | mano ',
        hasSkinTone: true),
    Emoji('👍', 'arriba | mano | pulgar | pulgar hacia arriba | señal',
        hasSkinTone: true),
    Emoji('👎', 'abajo | mano | pulgar | pulgar hacia abajo | señal',
        hasSkinTone: true),
    Emoji('✊', 'cerrado | mano | puñetazo | puño | puño en alto',
        hasSkinTone: true),
    Emoji('👊', 'puñetazo | puño | puño cerrado', hasSkinTone: true),
    Emoji('🤛', 'izquierda | puño | puño hacia la izquierda',
        hasSkinTone: true),
    Emoji('🤜', 'derecha | puño | puño hacia la derecha', hasSkinTone: true),
    Emoji('🫲', 'a la izquierda | izquierda | mano | mano hacia la izquierda',
        hasSkinTone: true),
    Emoji('🫱', 'a la derecha | derecha | mano | mano hacia la derecha',
        hasSkinTone: true),
    Emoji('👏', 'aplaudir | manos | manos aplaudiendo | palmas | señal',
        hasSkinTone: true),
    Emoji('🙌',
    ...
    Emoji('🤝', 'acuerdo | apretón | apretón de manos | manos',
        hasSkinTone: true),
    Emoji('🙏',
        'gracias | mano | manos en oración | oración | orar | por favor | rezar',
        hasSkinTone: true),
    Emoji('🫵', 'apuntar | dedo índice apuntándote a ti | ti | tú',
        hasSkinTone: true),
    Emoji('✍️', 'escribir | lápiz | mano | mano escribiendo ',
        hasSkinTone: true),
    Emoji('💅', 'cosmética | esmalte | manicura | pintarse las uñas | uñas',
        hasSkinTone: true),
    Emoji('🤳', 'autofoto | cámara | selfi | selfie | teléfono',
        hasSkinTone: true),
    Emoji('💪', 'bíceps | cómic | flexionado | fuerte | músculo',
        hasSkinTone: true),
    ...
    Emoji('🧔', 'barbas | barbudo | persona | persona con barba',
        hasSkinTone: true),
    Emoji('👱', 'persona adulta rubia | rubia | rubias | rubio | rubios',
        hasSkinTone: true),
    Emoji('👨‍🦰', 'adulto | hombre pelirrojo | pelo | rojizo | rojo ',
        hasSkinTone: true),
    Emoji('👨‍🦱',
        'adulto | hombre afro | bucle | pelo rizado | rizado | rizo | tirabuzón ',
        hasSkinTone: true),
    Emoji('👨‍🦳', 'adulto | hombre blanco | cana | gris | pelo | viejo ',
        hasSkinTone: true),
    Emoji('👨‍🦲',
    ...
    Emoji('👱‍♀️',
        ...
        hasSkinTone: true),
    Emoji('👩‍🦰', 'adulta | mujer pelirrojo | pelo | rojizo | rojo ',
        hasSkinTone: true),
    Emoji('👩‍🦱',
        'adulta | mujer afro | bucle | pelo rizado | rizado | rizo | tirabuzón ',
        hasSkinTone: true),
    Emoji('👩‍🦳', 'adulta | mujer blanco | cana | gris | pelo | viejo ',
        hasSkinTone: true),
    Emoji('👩‍🦲',
    ...
    Emoji(
        ...
        hasSkinTone: true),
    Emoji('👩‍🎓', 'estudiante | graduada | licenciada | mujer | universitaria',
        hasSkinTone: true),
    Emoji('👨‍🏫',
    ...
    Emoji('👩‍🏫',
        ...
        hasSkinTone: true),
    Emoji(
        '👨‍⚖️', 'adulto | hombre balanza | justicia | libra | peso | zodiaco ',
        hasSkinTone: true),
    Emoji(
        '👩‍⚖️', 'adulta | mujer balanza | justicia | libra | peso | zodiaco ',
        hasSkinTone: true),
    Emoji('👨‍🌾',
    ...
    Emoji('👩‍💻',
        ...
        hasSkinTone: true),
    Emoji('👨‍🎤', 'artista | cantante hombre | estrella | hombre | rock',
        hasSkinTone: true),
    Emoji('👩‍🎤', 'artista | cantante mujer | estrella | mujer | rock',
        hasSkinTone: true),
    Emoji('👨‍🎨', 'artista hombre | hombre | paleta | pintor | pinturas',
        hasSkinTone: true),
    Emoji('👩‍🎨', 'artista mujer | mujer | paleta | pintora | pinturas',
        hasSkinTone: true),
    ...
    Emoji('👨‍🚒', 'apagafuegos | bombero | bombero hombre | camión | manguera',
        hasSkinTone: true),
    Emoji('👩‍🚒', 'apagafuegos | bombera | bombera mujera | camión | manguera',
        hasSkinTone: true),
    Emoji('👮‍♂️',
    ...
    Emoji('🤵', 'esmoquin | novio | persona | persona con esmoquin',
        hasSkinTone: true),
    Emoji('👰', 'boda | novia | persona | persona con velo | velo',
        hasSkinTone: true),
    Emoji('🤰', 'embarazada | mujer', hasSkinTone: true),
    Emoji('🤱', 'amamantar | bebé | dar pecho | lactancia materna | pecho',
        hasSkinTone: true),
    ...
    Emoji('🧜‍♀️',
        ...
        hasSkinTone: true),
    Emoji('🧝‍♂️', 'elfo | mágico hombre | signo | signo masculino | símbolo ',
        hasSkinTone: true),
    Emoji('🧝‍♀️', 'elfo | mágico mujer | signo | signo femenino | símbolo ',
        hasSkinTone: true),
    Emoji(
      '🧞‍♂️',
    ...
    Emoji(
      '🧞‍♀️',
      'genio | lámpara mujer | signo | signo femenino | símbolo ',
    ),
    Emoji(
      '🧟‍♂️',
    ...
    Emoji('🧖‍♀️',
        ...
        hasSkinTone: true),
    Emoji('🧘', 'meditación | persona en posición de loto | yoga',
        hasSkinTone: true),
    Emoji('👭', 'lesbianas | mujeres | mujeres de la mano | novias | pareja',
        hasSkinTone: true),
    Emoji('👫',
        'hombre | hombre y mujer de la mano | mujer | mujer y hombre de la mano | novios | pareja',
        hasSkinTone: true),
    Emoji('👬', 'gays | hombres | hombres de la mano | novios | pareja',
        hasSkinTone: true),
    Emoji(
      '💏',
    ...
    Emoji(
      '💑',
      'amor | pareja | pareja enamorada | personas enamoradas',
    ),
    Emoji(
      '👨‍❤️‍👨',
    ...
    Emoji(
      '👨‍👩‍👦',
      'adulto | hombre adulta | mujer joven | niño ',
    ),
    Emoji(
      '👨‍👩‍👧',
      'adulto | hombre adulta | mujer chica | joven | niña ',
    ),
    Emoji(
      '👨‍👩‍👧‍👦',
    ...
    Emoji(
      '👨‍👨‍👦',
      'adulto | hombre adulto | hombre joven | niño ',
    ),
    Emoji(
      '👨‍👨‍👧',
      'adulto | hombre adulto | hombre chica | joven | niña ',
    ),
    Emoji(
      '👨‍👨‍👧‍👦',
    ...
    Emoji(
      '👩‍👩‍👦',
      'adulta | mujer adulta | mujer joven | niño ',
    ),
    Emoji(
      '👩‍👩‍👧',
      'adulta | mujer adulta | mujer chica | joven | niña ',
    ),
    Emoji(
      '👩‍👩‍👧‍👦',
    ...
    Emoji(
      '👨‍👦',
      'adulto | hombre joven | niño ',
    ),
    Emoji(
      '👨‍👦‍👦',
      'adulto | hombre joven | niño joven | niño ',
    ),
    Emoji(
      '👨‍👧',
      'adulto | hombre chica | joven | niña ',
    ),
    Emoji(
      '👨‍👧‍👦',
      'adulto | hombre chica | joven | niña joven | niño ',
    ),
    Emoji(
      '👨‍👧‍👧',
    ...
    Emoji(
      '👩‍👦',
      'adulta | mujer joven | niño ',
    ),
    Emoji(
      '👩‍👦‍👦',
      'adulta | mujer joven | niño joven | niño ',
    ),
    Emoji(
      '👩‍👧',
      'adulta | mujer chica | joven | niña ',
    ),
    Emoji(
      '👩‍👧‍👦',
      'adulta | mujer chica | joven | niña joven | niño ',
    ),
    Emoji(
      '👩‍👧‍👧',
    ...
    Emoji(
      '👤',
      'busto | silueta | silueta de busto',
    ),
    Emoji(
      '👥',
      'bustos | dos siluetas de bustos | siluetas',
    ),
    Emoji(
      '🫂',
...
// ======================================================= Category.ANIMALS
  CategoryEmoji(Category.ANIMALS, [
    Emoji(
      '🐶',
      'cara | cara de perro | mascota | perro',
    ),
    Emoji(
      '🐱',
    ...
    Emoji(
      '🐭',
      'cara | cara de ratón | ratón',
    ),
    Emoji(
      '🐹',
      'cara | hámster | mascota',
    ),
    Emoji(
      '🐰',
      'cara | cara de conejo | conejo | mascota',
    ),
    Emoji(
      '🦊',
      'cara | zorro',
    ...
    Emoji(
      '🐷',
      'cara | cara de cerdo | cerdo | gorrino',
    ),
    Emoji(
      '🐽',
    ...
    Emoji(
      '🙈',
      'cara | mal | mono | mono con los ojos tapados | prohibido',
    ),
    Emoji(
      '🙉',
      'cara | mal | mono | mono con los oídos tapados | prohibido',
    ),
    Emoji(
      '🙊',
      'cara | mal | mono | mono con la boca tapada | prohibido',
    ),
    Emoji(
      '🐒',
      'macaco | mono | simio',
    ...
    Emoji(
      '🦡',
      'ratel | tejón | tejón de la miel | tejón melero',
    ),
    Emoji(
      '🐾',
      'huellas | huellas de pezuñas | pezuñas',
    ),
    Emoji(
      '🦃',
      'ave | pavo',
    ...
    Emoji(
      '🐤',
      'ave | pollito | pollo | polluelo',
    ),
    Emoji(
      '🐥',
      'ave | pollito | pollito de frente | pollo',
    ),
    Emoji(
      '🐦',
    ...
    Emoji(
      '🦚',
      'ave | orgulloso | pavo | pavo real | plumas',
    ),
    Emoji(
      '🦜',
      'ave | hablar | loro | papagayo | pirata',
    ),
    Emoji(
      '🐊',
      'caimán | cocodrilo',
    ...
    Emoji(
      '🐲',
      'cara | cara de dragón | cuento | dragón | fantasía',
    ),
    Emoji(
      '🐉',
      'cuento | dragón | fantasía',
    ),
    Emoji(
      '🦕',
    ...
    Emoji(
      '🧌',
      'cuento de hadas | fantasía | monstruo | trol',
    ),
    Emoji(
      '🐳',
      'ballena | ballena soltando un chorro | chorro de agua',
    ),
    Emoji(
      '🐋',
    ...
    Emoji(
      '🕸️',
      'araña | tela | tela de araña | telaraña ',
    ),
    Emoji(
      '🦂',
    ...
    Emoji(
      '🦟',
      'fiebre | insecto | malaria | mosquito | virus',
    ),
    Emoji(
      '🦠',
      'ameba | bacteria | germen | microbio | virus',
    ),
    Emoji(
      '💐',
      'bouquet | flores | ramo | ramo de flores',
    ),
    Emoji(
      '🌸',
      'cerezo | flor | flor de cerezo',
    ),
    Emoji(
      '💮',
      'blanca | flor',
    ...
    Emoji(
      '🪷',
      'budismo | flor | hinduismo | loto | pureza',
    ),
    Emoji(
      '🌹',
      'flor | rosa',
    ...
    Emoji(
      '🌳',
      'árbol | árbol de hoja caduca | caducifolio | hoja caduca',
    ),
    Emoji(
      '🌴',
    ...
    Emoji(
      '🫧',
      'bajo el agua | burbujas | eructar | jabón | limpiar',
    ),
    Emoji(
      '🌊',
...
// ======================================================= Category.FOODS
  CategoryEmoji(Category.FOODS, [
    ...
    Emoji(
      '🍟',
      'papas fritas | patatas | patatas fritas | restaurante',
    ),
    Emoji(
      '🍕',
    ...
    Emoji(
      '🥪',
      'bocadillo | bocata | emparedado | sándwich',
    ),
    Emoji(
      '🌮',
    ...
    Emoji(
      '🥙',
      'comida | durum | falafel | kebab | pan de pita | pan relleno',
    ),
    Emoji(
      '🍳',
    ...
    Emoji(
      '🍲',
      'comida de olla | olla de comida | puchero | restaurante',
    ),
    Emoji(
      '🥣',
    ...
    Emoji(
      '🥮',
      'festival | luna | otoño | pastel de luna | yuebing',
    ),
    Emoji(
      '🍡',
    ...
    Emoji(
      '🧁',
      'cupcake | dulce | magdalena | repostería',
    ),
    Emoji(
      '🥧',
      'masa | pastel | relleno',
    ...
    Emoji(
      '🍼',
      'bebé | bibe | biberón | bibi | botella | leche',
    ),
    Emoji(
      '🥛',
    ...
    Emoji(
      '🍷',
      'bar | bebida | copa | copa de vino | vaso | vino',
    ),
    Emoji(
      '🍸',
...
// ======================================================= Category.TRAVEL
  CategoryEmoji(Category.TRAVEL, [
    ...
    Emoji(
      '🕋',
      'hach | islam | Kaaba | musulmán | religión | umrah',
    ),
    Emoji(
      '⛲',
      'fuente',
    ...
    Emoji(
      '🏎️',
      'carreras | coche | coche de carreras ',
    ),
    Emoji(
      '🏍️',
      'carreras | moto | motocicleta | vehículo ',
    ),
    Emoji(
      '🛵',
    ...
    Emoji(
      '🛞',
      'círculo | girar | neumático | rodar | rueda',
    ),
    Emoji(
      '🚨',
    ...
    Emoji(
      '⛵',
      'barco | barco de vela | velero | yate',
    ),
    Emoji(
      '🚤',
    ...
    Emoji(
      '🛫',
      'aeroplano | avión | avión despegando | salida',
    ),
    Emoji(
      '🛬',
      'aeroplano | avión | avión aterrizando | llegada',
    ),
    Emoji(
      '💺',
...
// ======================================================= Category.ACTIVITIES
  CategoryEmoji(Category.ACTIVITIES, [
    ...
    Emoji(
      '⛷️',
      'esquí | esquiador | nieve | persona esquiando ',
    ),
    Emoji(
      '🏂',
      'nieve | practicante de snowboard | snowboard',
    ),
    Emoji('🏌️‍♂️',
    ...
    Emoji(
      '🛝',
      'jugar | parque | parque de atracciones | tobogán',
    ),
    Emoji(
      '🏹',
    ...
    Emoji(
      '🛼',
      'patín | patín de 4 ruedas | patín de cuatro ruedas | patines',
    ),
    Emoji(
      '🛷',
      'trineo',
...
// ======================================================= Category.OBJECTS
  CategoryEmoji(Category.OBJECTS, [
    ...
    Emoji(
      '🧱',
      'arcilla | cemento | ladrillo | muro | pared',
    ),
    Emoji(
      '💈',
    ...
    Emoji(
      '🛢️',
      'barril | barril de petróleo | bidón | petróleo ',
    ),
    Emoji(
      '🛎️',
    ...
    Emoji(
      '🧿',
      'amuleto | mal de ojo | nazar | ojo turco | talismán',
    ),
    Emoji(
      '🪬',
      'amuleto | Fátima | hamsa | jamsa | mano | María | Miriam',
    ),
    Emoji(
      '🕹️',
    ...
    Emoji(
      '💰',
      'bolsa | bolsa de dinero | bolsa de dólares | dinero',
    ),
    Emoji(
      '💴',
      'billete | billete de banco | billete de yen | dinero | yen',
    ),
    Emoji(
      '💵',
    ...
    Emoji(
      '💶',
      'billete | billete de banco | billete de euro | dinero | euro',
    ),
    Emoji(
      '💷',
      'billete de banco | billete de libra | dinero | libra',
    ),
    Emoji(
      '💸',
    ...
    Emoji(
      '📧',
      'comunicación | correo | correo electrónico | sobre',
    ),
    Emoji(
      '📨',
    ...
    Emoji(
      '🗳️',
      'papeleta | urna | urna con papeleta | voto ',
    ),
    Emoji(
      '✏️',
    ...
    Emoji(
      '✒️',
      'bolígrafo | escribir | pluma | pluma negra | tinta ',
    ),
    Emoji(
      '🖋️',
      'bolígrafo | escribir | estilográfica | pluma | tinta ',
    ),
    Emoji(
      '🖊️',
    ...
    Emoji(
      '🖍️',
      'cera | lápiz | lápiz de cera ',
    ),
    Emoji(
      '📝',
      'comunicación | cuaderno de notas',
    ),
    Emoji(
      '📁',
      'archivo | carpeta | carpeta de archivos',
    ),
    Emoji(
      '📂',
      'abierta | archivo | carpeta | carpeta de archivos abierta',
    ),
    Emoji(
      '🗂️',
      'fichas | fichero | separador | separador de fichas ',
    ),
    Emoji(
      '📅',
      'calendario | fecha',
    ...
    Emoji(
      '📆',
      'calendario | calendario recortable | fecha',
    ),
    Emoji(
      '🗒️',
    ...
    Emoji(
      '🗓️',
      'calendario | calendario de espiral | espiral ',
    ),
    Emoji(
      '📇',
    ...
    Emoji(
      '📊',
      'barras | gráfico | gráfico de barras',
    ),
    Emoji(
      '📋',
      'papeles | pinza | portapapeles | tabla',
    ),
    Emoji(
      '📌',
      'chincheta | tachuela',
    ...
    Emoji(
      '🗃️',
      'archivador | archivador de tarjetas | archivo | caja ',
    ),
    Emoji(
      '🗄️',
    ...
    Emoji(
      '🔐',
      'candado | candado cerrado y llave | cerrado | llave | seguro',
    ),
    Emoji(
      '🔑',
      'contraseña | llave',
    ...
    Emoji(
      '⚒️',
      'herramienta | martillo | martillo y pico | pico ',
    ),
    Emoji(
      '🛠️',
    ...
    Emoji(
      '🔩',
      'herramienta | tornillo | tornillo y tuerca | tuerca',
    ),
    Emoji(
      '⚙️',
    ...
    Emoji(
      '🗜️',
      'herramienta | tornillo | tornillo de banco ',
    ),
    Emoji(
      '⚖️',
    ...
    Emoji(
      '🧰',
      'armario | caja de herramientas | herramienta | mecánico',
    ),
    Emoji(
      '🧲',
      'atracción | herradura | imán | magnético',
    ),
    Emoji(
      '⚗️',
    ...
    Emoji(
      '📡',
      'antena | antena de satélite | comunicación | satélite',
    ),
    Emoji(
      '💉',
    ...
    Emoji(
      '🧻',
      'papel absorbente | papel higiénico | rollo de papel',
    ),
    Emoji(
      '🧼',
    ...
    Emoji(
      '🧽',
      'absorbente | esponja | limpiar | poroso',
    ),
    Emoji(
      '🧯',
      'apagar | extinguir | extintor | incendio',
    ),
    Emoji(
      '🚬',
...
// ======================================================= Category.SYMBOLS
  CategoryEmoji(Category.SYMBOLS, [
    ...
    Emoji(
      '💢',
      'cómic | enfadado | enfado | símbolo de enfado',
    ),
    Emoji(
      '💬',
    ...
    Emoji(
      '💤',
      'cómic | dormir | símbolo de sueño | sueño | zzz',
    ),
    Emoji(
      '💮',
      'blanca | flor',
    ...
    Emoji(
      '♉',
      'buey | horóscopo | Tauro | toro | zodiaco',
    ),
    Emoji(
      '♊',
      'gemelos | Géminis | horóscopo | zodiaco',
    ),
    Emoji(
      '♋',
    ...
    Emoji(
      '♌',
      'horóscopo | Leo | león | zodiaco',
    ),
    Emoji(
      '♍',
      'horóscopo | Virgo | zodiaco',
    ),
    Emoji(
      '♎',
      'balanza | escala | horóscopo | justicia | Libra | zodiaco',
    ),
    Emoji(
      '♏',
    ...
    Emoji(
      '♐',
      'arquero | horóscopo | Sagitario | zodiaco',
    ),
    Emoji(
      '♑',
      'cabra | Capricornio | horóscopo | zodiaco',
    ),
    Emoji(
      '♒',
    ...
    Emoji(
      '♓',
      'horóscopo | pescado | pez | Piscis | zodiaco',
    ),
    Emoji(
      '⛎',
      'horóscopo | Ofiuco | portador | serpiente | zodiaco',
    ),
    Emoji(
      '🔀',
...
// ======================================================= Category.FLAGS
  CategoryEmoji(Category.FLAGS, [
    ...
    Emoji(
      '🎌',
      'banderas | banderas cruzadas | celebración | japón',
    ),
    Emoji(
      '🏴',
    ...
    Emoji(
      '🏳️‍🌈',
      'bandera | blanca | ondear arcoíris | colores | lluvia ',
    ),
    Emoji(
      '🏳️‍⚧️',
