...
///
class CustomSearchPickerView extends EmojiPickerBuilder {
  ///
  CustomSearchPickerView(Config config, EmojiViewState state)
      : super(config, state);
...
class _CustomViewState extends State<CustomSearchPickerView>
